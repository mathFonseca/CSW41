...
extern void servo_write0(uint16_t angle);
extern void servo_write1(uint16_t angle);
extern void servo_write2(uint16_t angle);
extern void servo_write3(uint16_t angle);
